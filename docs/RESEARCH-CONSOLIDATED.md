...
This document consolidates the findings of the 10 research tracks run during the project. The full notes are too verbose for the README; here we keep the highest-signal conclusions.
