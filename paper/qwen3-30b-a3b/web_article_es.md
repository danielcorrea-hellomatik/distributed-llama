...
| Mejora sobre vanilla en el mismo silicio de 16 GB (sin sesgos) | **+15,2%** |
...
- **Paper, código y datos en bruto:** [github.com/hellomatik-org/distributed-llama](https://github.com/hellomatik-org/distributed-llama/tree/pi5-cluster) (rama `pi5-cluster`, `paper/`).
