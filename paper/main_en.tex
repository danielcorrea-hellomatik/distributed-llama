...
\title{
  ...
  {\normalsize Qwen3-30B-A3B (MoE) over patched distributed-llama, 12.71 tok/s sustained (initial), \textbf{14.046 tok/s} post-publication updates through Round 4 (May 17, 2026)}
}
\author{
...
\subsection{Updated bottom line}

The cluster sustains \textbf{14.046 tok/s} ($\pm$0.049 at 95\% CI, $n$=20, cold-cluster), \textbf{+7.72\% above the publicly documented ceiling} of 13.04 tok/s for Qwen3-30B-A3B Q40 on $4\times$Pi 5. Round 3 and Round 4 contributed no measurable gain over Stage 9 + A2 individually, but the cumulative defensive state (persisted sysctls, EEVDF tuning, Phase B foundation in repo, +0.5\% A2 fusion) represents a maintainable production baseline.
