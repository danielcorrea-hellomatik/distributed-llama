...
After the initial publication of this report at 12.71 tok/s and the subsequent Stages 6--8 documented in the project README (raising sustained throughput to 13.720 tok/s), a structured six-subagent research round identified one further round of OS-level network and memory tunings that yielded a measurable improvement without any source-code changes.
