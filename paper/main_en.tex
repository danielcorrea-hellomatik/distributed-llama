...
\title{Distributed LLM Inference on a 4-Node Raspberry Pi~5 Cluster:\\[0.15cm]
       An Empirical Evaluation of Frameworks, Bit-Exact Optimisations,\\
...
HALO \cite{halo2026} & \texttt{distributed-llama} + 3{,}500 LOC overlap & 1.30$\times$ over baseline on reliable LAN & bit-exact & Source not yet public; if released, would project our cluster to $\sim$16.5 tok/s \\
