...
- **Article, code et données brutes :** [github.com/hellomatik-org/distributed-llama](https://github.com/hellomatik-org/distributed-llama/tree/kernel-opt-t02) (branche `kernel-opt-t02`, `paper/`).
