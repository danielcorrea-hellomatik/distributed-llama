...
Stage 14 --- \texttt{MAX\_CHUNK\_SIZE} 4K $\to$ 16K (\texttt{f8ed9d2}) & \textbf{14.449} & 0.038 & $+$1.34\% vs S13 \\
Stage 15 --- runtime tweaks persisted via systemd (\texttt{edbc4ce}) & 14.449 & 0.038 & flat \\
\midrule
\textbf{Final, all bit-exact changes (Stages 1--15)}       & \textbf{14.449} & \textbf{0.038} & \textbf{$+$5.31\% vs S8} \\
